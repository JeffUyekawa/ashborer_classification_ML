...
def bandpass_filter(data,fs, lowcut=1000, highcut=10000, order=5, pad = 0):
    nyquist = 0.5 * fs
    low = lowcut / nyquist
...
def simulate_real_time_classification(model,wav_file, duration = 30, live = True, band = False):
    ...
    if sr != 96000:
        ...
        start = int(5*sr)
        audio_data = audio_data[0,start:].reshape(1,-1)
        audio_data = resampler(audio_data)
        duration = 25
        sr = 96000
    if audio_data.shape[0] > 1:
        print('reshaping clip')
        print(f'Shape before: {audio_data.shape}')
        audio_data = audio_data[1,:].reshape(1,-1)
        print(f'Shape After: {audio_data.shape}')    
    num_chunks = int(duration * 1000/25)
    times_list = []
    if live:
        audio_data = audio_data/audio_data.max()
        sd.play(audio_data[0].numpy(),sr)
        try:
...
if __name__ == "__main__":
    ...
    #model.load_state_dict(torch.load(r"C:\Users\jeffu\Downloads\new_2D (1).pt", map_location='cpu'))
    #Clip recorded at 48k
    #wav_file = r"C:\Users\jeffu\Documents\Recordings\all_recordings\07_25_2024_LAB\2024-07-25_09_51_20.wav"
    ...
    #wav_file = r"C:\Users\jeffu\Documents\Recordings\all_recordings\06_27_2024_R1\2024-06-24_15_02_24.wav"
    #wav_file = r"C:\Users\jeffu\Documents\Recordings\all_recordings\06_27_2024_R1\2024-06-24_15_13_04.wav"
    ...
    #96k Forestry
    #wav_file = r"C:\Users\jeffu\Documents\Recordings\all_recordings\06_28_2024_F1\2024-06-27_14_31_12.wav"
    
    #Good one
    #wav_file = r'C:\\Users\\jeffu\\Documents\\Recordings\\all_recordings\\06_28_2024_F1\\2024-06-28_09_48_33.wav'
    #wav_file = r"C:\Users\jeffu\Documents\Ash Borer Project\Datasets\recordings_for_test\2024-05-21_16_25_40.wav"
    ...
    #wav_file = r"C:\Users\jeffu\Downloads\recorded_audio.wav"


    #Demo
    wav_file = r"C:\Users\jeffu\Documents\Recordings\test_set\2024-05-20_10_53_33.wav"
    y, fs = ta.load(wav_file)
    duration = y.shape[1]/fs
    print('Beginning Simulation')
    times = simulate_real_time_classification(model,wav_file, duration=duration, live = True, band = False)
    if fs != 96000:
...
import pandas as pd
import os
path = r"C:\Users\jeffu\Documents\Recordings\all_recordings\06_28_2024_F1"
detected = 0
false_positives = []
for file in os.listdir(path):
    wav_file = os.path.join(path,file)
    times = simulate_real_time_classification(model,wav_file,duration=30, live = True)
