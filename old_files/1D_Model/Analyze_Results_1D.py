...
df.to_csv(r"C:\Users\jeffu\Documents\Ash Borer Project\Datasets\test_set_preds96k.csv")
# %%
import pandas as pd
...
import matplotlib.pyplot as plt
#df.drop(df[df['File'] == '2024-08-28_09_40_37.wav'].index, axis = 0, inplace = True)
#%%
#df1 = df.drop(df[df['File'] == '2024-06-24_18_49_27.wav'].index, axis = 0)
