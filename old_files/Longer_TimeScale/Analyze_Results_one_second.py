...
class CNNNetwork(nn.Module):
    ...
    def __init__(self):
        ...
        self.linear1=nn.Linear(in_features=3584,out_features=128)
        self.ReLU = nn.ReLU()
...
if __name__ == '__main__':
    AUDIO_PATH = r"C:\Users\jeffu\Documents\Recordings\one_second_validation"
    ANNOTATION_PATH = filter_labeled_data(r"C:\Users\jeffu\Documents\Recordings\one_second_validation_labels.csv")
    test_data = borer_data(ANNOTATION_PATH,AUDIO_PATH,mel = True)
    data_loader = DataLoader(test_data, batch_size = 1, num_workers = 0, shuffle = False)
    preds = []
    model = CNNNetwork()
    #model = nn.DataParallel(model)
    model.load_state_dict(torch.load(r"C:\Users\jeffu\Downloads\one_second_checkpoint (4).pt", map_location = 'cpu'))
