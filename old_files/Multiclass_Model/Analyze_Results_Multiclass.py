...
if __name__ == '__main__':
    ...
    ANNOTATION_PATH = filter_labeled_data(r"C:\Users\jeffu\Documents\Recordings\multiclass_test_upsampled.csv")
    ...
    model.load_state_dict(torch.load(r"C:\Users\jeffu\Downloads\Multiclass_Overfit (1).pt",map_location='cpu'))
...
df.to_csv(r"C:\Users\jeffu\Documents\Ash Borer Project\Datasets\test_set_preds_multiclass.csv")
# %%
import pandas as pd
import matplotlib.pyplot as plt
import numpy as np
df = pd.read_csv(r"C:\Users\jeffu\Documents\Ash Borer Project\Datasets\test_set_preds_multiclass.csv")
...
#bad_files = (df['File']=='2024-08-28_09_48_55.wav')|(df['File']=='2024-08-28_10_09_52.wav')
#df = df.loc[~bad_files,:]
#%%
y_true = df['Label']
...
# %%
df_train = pd.read_csv(r"C:\Users\jeffu\Documents\Recordings\multiclass_training_upsampled.csv")
df_test = pd.read_csv(r"C:\Users\jeffu\Documents\Recordings\multiclass_test_upsampled.csv")


# %%
df_train.loc[df_train.Label.eq(2),'Label'] = 0
df_test.loc[df_test.Label.eq(2),'Label'] = 0
# %%
